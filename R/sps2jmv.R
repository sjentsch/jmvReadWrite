...
getVar <- function(crrSPS = c()) {
    if (grepl(paste0("^DATASET|^GET FILE|^GET DATA|^SAVE OUTFILE=|^NEW FILE|^USE ALL$|^FILTER|^EXECUTE$|^TITLE|^COMPUTE|^DELETE VARIABLES|^FORMATS|^VARIABLE LABELS|^VALUE LABELS|",
