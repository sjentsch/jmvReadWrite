...
write_omv <- function(dtaFrm = NULL, fleNme = "") {
    ...
    mnfTxt <- c("Manifest-Version: 1.0", "Data-Archive-Version: 1.0.2", "jamovi-Archive-Version: 8.0", paste("Created-By: jmvReadWrite", utils::packageVersion("jmvReadWrite")))
    writeLines(mnfTxt, con = 'meta', sep='\n');
    ...
    resHTM <- c('<!DOCTYPE html>',
                ...
                '        <style>\n',
                '    body {', '        font-family: "Segoe UI",Roboto,Helvetica,Arial,sans-serif,"Segoe UI Emoji","Segoe UI Symbol" ;',
                                                  '        font-size: 12px ;', '        color: #333333 ;', '        margin: 24px;',             '        cursor: default ;',     '    }\n',
                '    h1 {',                       '        font-size: 160% ;', '        color: #3E6DA9 ;', '        margin-bottom: 12px ;',     '        white-space: nowrap ;', '    }\n',
                '    h2 {',                       '        font-size: 130% ;', '        color: #3E6DA9 ;', '        margin-bottom: 12px ;',                                      '    }\n',
                '    h3, h4, h5 {',               '        font-size: 110% ;',                             '        margin-bottom: 12px ;',                                      '    }\n',
                '    table {',                                                                             '        page-break-inside: avoid;', '        border-spacing: 0 ;',   '    }\n',
                '    table tr td, table tr th {', '        font-size: 12px ;',                             '        page-break-inside: avoid;',                                  '    }\n',
                '        </style>',
                '</head>',
                '<body>\n', '</body>',
                '</html>')
