...
* [`create_analyses_omv`](https://sjentsch.github.io/jmvReadWrite/reference/create_analyses_omv.html):
  Adds analyses (based upon a vector with jamovi-functions, such as those produced when the Syntax
  Mode is switched on in jamovi) to a data set.
