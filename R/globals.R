...
# command terminator '.' after 'CACHE', 'EXECUTE', 'NEW FILE', 'PRESERVE'; and , extended 'SAVE' to 'SAVE OUTFILE' and 'GET' to 'GET FILE')
cmdSPS = c('2SLS', 'ACF', 'ADD DOCUMENT', 'ADD FILES', 'ADD VALUE LABELS', 'ADP', 'AGGREGATE', 'AIM', 'ALSCAL', 'ALTER TYPE', 'ANACOR', 'ANOVA', 'APPLY DICTIONARY', 'AREG', 'ARIMA', 'AUTORECODE',
           ...
           'FACTOR', 'FILE HANDLE', 'FILE LABEL', 'FILE TYPE', 'FILTER', 'FINISH', 'FIT', 'FLEISS MULTIRATER KAPPA', 'FLIP', 'FORMATS', 'FREQUENCIES', 'GENLIN', 'GENLINMIXED', 'GENLOG', 'GET FILE',
           ...
           'RESTORE', 'RMV', 'ROC', 'ROC ANALYSIS', 'SAMPLE', 'SAVE CODEPAGE', 'SAVE DATA COLLECTION', 'SAVE MODEL', 'SAVE OUTFILE', 'SAVETM1', 'SAVE TRANSLATE', 'SCRIPT', 'SEASON', 'SELECT IF',
