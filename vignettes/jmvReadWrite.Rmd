...
to ease using syntax for statistical analyses created using the GUI in `jamovi`
...
[`Syntax Mode`](https://jamovi.readthedocs.io/en/latest/usermanual/um_6_syntax_mode.html).
