test_that("describe_omv works", {
    ...
    expect_equal(as.vector(sapply(df4Chk, typeof)), c("double", "integer", "double"))
    ...
    expect_equal(sapply(attr(df4Chk, "protobuf")[[1]]$options$options, class), rep("Message", 2))
    ...
    expect_equal(sapply(attr(df4Chk, "protobuf")[[1]]$options$options[[1]]$c$options[[1]]$c$options, class), rep("Message", 24))
    ...
    expect_equal(sapply(attr(df4Chk, "protobuf")[[1]]$options$options[[1]]$c$options[[1]]$c$options, class), rep("Message", 46))
    expect_equal(attr(df4Chk, "protobuf")[[1]]$options$options[[1]]$c$options[[1]]$c$options[[1]]$c$names, c("attributes", "insert"))
    expect_equal(attr(df4Chk, "protobuf")[[1]]$options$options[[1]]$c$options[[1]]$c$options[[1]]$c$as.character(),
      paste0("options {\n  c {\n    options {\n      o: TRUE\n    }\n    hasNames: true\n    names: \"bold\"\n  }\n}\n",
    ...
    expect_s4_class(attr(df4Chk, "protobuf")[[1]]$options, "Message")
    expect_length(attr(df4Chk, "protobuf")[[1]]$options, 3)
    expect_equal(sapply(attr(df4Chk, "protobuf")[[1]]$options$options, class), rep("Message", 1))
    ...
    rm(nmeOut, lstDsc, chrDsc, df4Chk)
})
