...
#' @param fleOut name (including the path, if required) of the data file to be written ("FILENAME.omv"; default: ""); if empty, FILENAME from fleIn1 is extended with "_addRows"
...
#'
merge_rows_omv <- function(fleIn1 = "", fleIn2 = "", fleOut = "", typMrg = c("inner", "outer", "left", "right", "cross")) {
